...
const NotificationIcons = ({ type }: NotificationIconsProps) => {
  switch (type) {
    case "default":
      return (
        <svg
      ...
      return (
        ...
        >
          <NotificationIconPath
            ...
            fill="#B3B3B3"
          />
          <NotificationIconCircle cx="21.5" cy="2.5" r="2.5" fill="#B3B3B3" />
        </svg>
      );
...
const NotificationIconPath = styled.path`
  fill: ${({ theme }) => theme.colors.gray4};
`;

const NotificationIconCircle = styled.circle`
  fill: ${({ theme }) => theme.colors.gray4};
`;
